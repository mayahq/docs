...
<Info>
  The Maya Labs Python SDK provides easy async access to our PAC-1 program
  synthesis engine, with a CLI to instruct and generate programs from
...
<CardGroup cols={2}>
  <Card
    title="Get API Key"
    icon="pen-to-square"
    href="https://app.mayalabs.io/settings/developers"
  >
